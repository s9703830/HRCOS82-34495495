...
extern "C" uint8_t _EEPROM_start = PICO_FLASH_SIZE_BYTES - FLASH_SECTOR_SIZE*4; // gives us 4KB * 4 = 16KB of EEPROM
...
bool EEPROMClass::commit() {
    ...
    noInterrupts();
    // comment out the core1 sleep logic, MBEDOS does not support raspberry pi pico multicore, all run on core0 only
